...
//
//        map.put(new Integer[]{1234, 764}, 0);
//        System.out.println("map.containsKey(new int[]{1234,764}) = " + map.containsKey(new Integer[]{1234, 764}));
//        System.out.println("map.get(new Integer[]{1234, 764}) = " + map.get(new Integer[]{1234, 764}));
